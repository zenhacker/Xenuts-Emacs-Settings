...
;;cedet插件设置
;;==================================================
(add-to-list 'load-path "~/emacs-lisp/cedet-1.0/speedbar")
(add-to-list 'load-path "~/emacs-lisp/cedet-1.0/eieio")
(add-to-list 'load-path "~/emacs-lisp/cedet-1.0/semantic")
;; Load CEDET.,从cedet的INSTALL中复制过来的
;; See cedet/common/cedet.info for configuration details.
(load-file "~/emacs-lisp/cedet-1.0/common/cedet.el")
